...
namespace KeyAuth
{
    public partial class Login : Form
    {
        ...
        */
        ...
        static string name = "et"; // application name. right above the blurred text aka the secret on the licenses tab among other tabs
        static string ownerid = "et"; // ownerid, found in account settings. click your profile picture on top right of dashboard and then account settings.
        static string secret = "ert"; // app secret, the blurred text on licenses tab and other tabs
